...
const routes = [
    ...
    {
        path: 'module-zero',
        loadChildren: () => __webpack_require__.e(/*! import() | module-zero-module-zero-module */ "module-zero-module-zero-module").then(__webpack_require__.bind(null, /*! ./module-zero/module-zero.module */ "./src/app/module-zero/module-zero.module.ts")).then(m => m.ModuleZeroPageModule)
    }
];
...
module.exports = __webpack_require__(/*! /Users/hannahhostetter/Desktop/IUPUI Spring 2020/Project Development/MIMA/src/main.ts */"./src/main.ts");
